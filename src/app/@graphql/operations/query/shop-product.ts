...
export const SHOP_LAST_UNITS_OFFERS = gql`
  query shopProductsOfferLast($page: Int, $itemsPage: Int, $active: ActiveFilterEnum, $random: Boolean, $topPrice: Float $lastUnits: Int,
                              $showInfo: Boolean = false, $showPlatform: Boolean = false, $relationScreens: Boolean = false) {
...
export const SHOP_PRODUCT_DETAILS = gql`
  query shopProductDetails($id: Int!, $showPlatform: Boolean = true, $relationScreens: Boolean = true) {
...
export const SHOP_PRODUCT_RANDOM_ITEMS = gql`
  query randomItems($showPlatform: Boolean = true, $relationScreens: Boolean = false) {
